...
The question arises, what we can actually conclude from these insights.
...
Morover, the pure distribution of outputs does not yet convey information about
how sensitive results are to particular cost assumptions.
But knowing the technologies for which lowering overnight costs has a big impact
is important too promote technological learning in that direction.
...
(including 6h energy capacity at full power output),
whereas hydrogen storage features a steady slope.
...
The limited uncertainty about cost-optimal levels of grid expansion is mostly caused by the cost of hydrogen storage.
