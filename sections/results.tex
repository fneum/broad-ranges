...
% TODO what is the conclusion or takeaway message?
...
as well as system layouts that do not meet low-cost criteria in any circumstances for varying $\epsilon$ in \cref{fig:fuzzycone}.
...
pairs at fixed system cost increase of $\epsilon=6\%$ for which we expect the most interesting trade-offs.
