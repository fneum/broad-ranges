...
(v) using the model approximation for statistial analysis.
...
The remaing question is, how many samples are required to 
...
- It is desirable only high-fidelity for surrogate model is time-consuming
...
% TODO: model validation in methods or results?
