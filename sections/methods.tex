...
to the set of linear constraints in \crefrange{eq:firstA}{eq:lastA} as $Ax\leq b$.
\begin{equation}
...
- the instance of coordinated capacity expansion problem
...
\subsubsection{Surrogate Modelling using Polynomial Chaos Expansion}
