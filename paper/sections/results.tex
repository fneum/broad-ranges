...
\begin{figure}
    ...
    \end{subfigure}
    } \caption{ Space of near-optimal solutions by technology under cost
...
\begin{figure}
    ...
    \vspace{1cm}
    \caption{ Space of near-optimal solutions by selected pairs of technologies
...
The aforementioned contour plots \crefrange{fig:fuzzycone}{fig:dependencies}
...
we show in \crefrange{fig:nearviolin:onwind}{fig:nearviolin:transmission} how
