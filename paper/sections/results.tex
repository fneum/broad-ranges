...
\todo{explain here the bars and dots?}
...
once its annuity falls below 75 EUR/kW/a\todo{translate into CAPEX!} (including 6h energy capacity at full
...
towards inputs at least-cost solutions only. However, it has been previously shown
that even for a single cost parameter set a wide array of technologically
diverse but similarly costly solutions exists \cite{nearoptimal}. We now
examine how technology cost uncertainty affects the shape of the space of
near-optimal alternatives within 8\%\todo{why 8\%?} of the least-cost solution.
...
The level of required transmission expansion is least affected by the cost uncertainty.\todo{Perhaps because we didn't include cost uncertainty on transmission?}
...
Hydrogen storage, symbolising long-term storage, also is a vital technology in many cases.
