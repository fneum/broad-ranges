...
% TODO more detailed explanation of deterministic near-optimal cones

% e boundaries delineate Pareto frontiers on which no crite-
% rion, neither reducing system cost nor extremising the capacity of a technology, can
% be improved without depressing the other.
