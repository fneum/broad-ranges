...
\begin{figure}
    \begin{subfigure}[t]{0.32\textwidth}
        ...
        \includegraphics[width=\textwidth]{../notebooks/graphics/1D/1D-onwind-onwind-high.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
        \caption{offshore wind}
        \includegraphics[width=\textwidth]{../notebooks/graphics/1D/1D-offwind-offwind-high.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
        \caption{solar}
        \includegraphics[width=\textwidth]{../notebooks/graphics/1D/1D-solar-solar-high.pdf}
    \end{subfigure} \\
    \begin{subfigure}[t]{0.32\textwidth}
        \caption{battery storage}
        \includegraphics[width=\textwidth]{../notebooks/graphics/1D/1D-battery-battery-high.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
        \caption{hydrogen storage}
        \includegraphics[width=\textwidth]{../notebooks/graphics/1D/1D-H2-H2-high.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
        \caption{transmission}
        \includegraphics[width=\textwidth]{../notebooks/graphics/1D/1D-transmission-H2-high.pdf}
    \end{subfigure}
    \vspace{-0.3cm}
    \caption{
...
once its cost falls below 785 EUR/kW (including 6-hour energy capacity at full
